...
// The DISABLE_AUTHENTICATION block is already uncommented (active), matching
// this fixture's state file, which records auth-mode-applied as done for
// scopeChoice "local-no-login".
