...
- ✅ Sharp image library is installed (`cd .Codex/skills/scrape-webpage/scripts && npm install`)
...
**Command:**
```bash
node .Codex/skills/scrape-webpage/scripts/analyze-webpage.js "https://example.com/page" --output ./import-work
```
...
**Sharp not installed:**
```bash
cd .Codex/skills/scrape-webpage/scripts && npm install
```
