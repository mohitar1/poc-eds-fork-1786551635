...
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js <search-term> & \
node .Codex/skills/block-collection-and-party/scripts/search-block-collection.js <search-term> & \
wait
```
...
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js accordion & \
node .Codex/skills/block-collection-and-party/scripts/search-block-collection.js accordion & \
wait

# Search for embed block (both scripts)
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js embed & \
node .Codex/skills/block-collection-and-party/scripts/search-block-collection.js embed & \
wait

# If running both is problematic, prioritize the GitHub API version
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js carousel
```
...
```bash
node .Codex/skills/block-collection-and-party/scripts/search-block-party.js [--category <category>] <search-term> [additional-terms...]
```
...
node .Codex/skills/block-collection-and-party/scripts/search-block-party.js breadcrumb

# Search for Sass integration examples
node .Codex/skills/block-collection-and-party/scripts/search-block-party.js sass

# Search only for build tooling
node .Codex/skills/block-collection-and-party/scripts/search-block-party.js --category "Build Tooling" webpack

# Multi-word search
node .Codex/skills/block-collection-and-party/scripts/search-block-party.js adobe target integration
```
...
```bash
node .Codex/skills/block-collection-and-party/scripts/get-block-structure.js <block-name>
```
...
node .Codex/skills/block-collection-and-party/scripts/get-block-structure.js accordion

# Get cards structure (will show multiple variants)
node .Codex/skills/block-collection-and-party/scripts/get-block-structure.js cards

# Get tabs structure
node .Codex/skills/block-collection-and-party/scripts/get-block-structure.js tabs
```
...
1. Search Block Collection first with both scripts:
   ```bash
   node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js breadcrumb & \
   node .Codex/skills/block-collection-and-party/scripts/search-block-collection.js breadcrumb & \
   wait
   ```
2. Find that breadcrumbs is "default-content" (not a standalone block)
3. Search Block Party: `node .Codex/skills/block-collection-and-party/scripts/search-block-party.js breadcrumb`
...
3. Search Block Party: `node .Codex/skills/block-collection-and-party/scripts/search-block-party.js --category "Build Tooling" sass`
...
1. Search Block Collection with both scripts:
   ```bash
   node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js carousel & \
   node .Codex/skills/block-collection-and-party/scripts/search-block-collection.js carousel & \
   wait
   ```
2. Find Block Collection carousel from both search results
3. Also search Block Party: `node .Codex/skills/block-collection-and-party/scripts/search-block-party.js carousel`
