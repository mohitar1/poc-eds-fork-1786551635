...
```bash
node .Codex/skills/docs-search/scripts/search.js [--all] <keyword1> [keyword2] [...]
```
...
node .Codex/skills/docs-search/scripts/search.js block decoration

# Search for metadata with all results
node .Codex/skills/docs-search/scripts/search.js --all metadata

# Multi-word search
node .Codex/skills/docs-search/scripts/search.js universal editor blocks
```
...
Index files are cached locally for 24 hours in `.Codex/skills/docs-search/.cache/`. This speeds up subsequent searches.
...
**Good Approach:**
1. Search: `node .Codex/skills/docs-search/scripts/search.js block decoration`
...
**Good Approach:**
1. Search: `node .Codex/skills/docs-search/scripts/search.js metadata`
