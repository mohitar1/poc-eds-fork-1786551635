...
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js hero &
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js cards &
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js columns &
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js accordion &
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js tabs &
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js carousel &
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js quote &
node .Codex/skills/block-collection-and-party/scripts/search-block-collection-github.js fragment &
wait
```
