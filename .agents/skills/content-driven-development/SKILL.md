...
node .Codex/skills/content-driven-development/scripts/find-block-content.js <block-name>

# Search for specific variant
node .Codex/skills/content-driven-development/scripts/find-block-content.js <block-name> localhost:3000 <variant>

# Search on live site
node .Codex/skills/content-driven-development/scripts/find-block-content.js <block-name> main--repo--owner.aem.live

# Search on preview with variant
node .Codex/skills/content-driven-development/scripts/find-block-content.js <block-name> main--repo--owner.aem.page <variant>
```

**Examples:**
```bash
node .Codex/skills/content-driven-development/scripts/find-block-content.js hero
node .Codex/skills/content-driven-development/scripts/find-block-content.js hero localhost:3000 dark
node .Codex/skills/content-driven-development/scripts/find-block-content.js cards main--site--owner.aem.live three-up
```
